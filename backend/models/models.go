...
type Material struct {
	...
	Supplier      sql.NullString `json:"supplier" db:"supplier"`
...
type MaterialBatch struct {
	...
	SupplierBatch  sql.NullString `json:"supplierBatch" db:"supplier_batch"`
	Status         int            `json:"status" db:"status"`
	Warehouse      sql.NullString `json:"warehouse" db:"warehouse"`
	Inspector      sql.NullString `json:"inspector" db:"inspector"`
	Remark         sql.NullString `json:"remark" db:"remark"`
	CreatedAt      time.Time      `json:"createdAt" db:"created_at"`
	UpdatedAt      time.Time      `json:"updatedAt" db:"updated_at"`
	MaterialCode   string         `json:"materialCode,omitempty" db:"-"`
	MaterialName   string         `json:"materialName,omitempty" db:"-"`
	MaterialType   int            `json:"materialTypeCode,omitempty" db:"-"`
	Specification  string         `json:"specificationName,omitempty" db:"-"`
	Supplier       string         `json:"supplierName,omitempty" db:"-"`
}
...
type ProductionBatch struct {
	...
	BatchNo        string         `json:"batchNo" db:"batch_no"`
	WorkOrder      sql.NullString `json:"workOrder" db:"work_order"`
	...
	ProductionLine sql.NullString `json:"productionLine" db:"production_line"`
	Status         int            `json:"status" db:"status"`
	CreatedBy      sql.NullString `json:"createdBy" db:"created_by"`
	Remark         sql.NullString `json:"remark" db:"remark"`
	CreatedAt      time.Time      `json:"createdAt" db:"created_at"`
	UpdatedAt      time.Time      `json:"updatedAt" db:"updated_at"`
	ProductCode    string         `json:"productCode,omitempty" db:"-"`
...
type Equipment struct {
	...
	EquipType    sql.NullString `json:"equipType" db:"equip_type"`
	Location     sql.NullString `json:"location" db:"location"`
	Manufacturer sql.NullString `json:"manufacturer" db:"manufacturer"`
	PurchaseDate sql.NullString `json:"purchaseDate" db:"purchase_date"`
	Status       int            `json:"status" db:"status"`
	Description  sql.NullString `json:"description" db:"description"`
	CreatedAt    time.Time      `json:"createdAt" db:"created_at"`
	UpdatedAt    time.Time      `json:"updatedAt" db:"updated_at"`
...
type ProductionLog struct {
	...
	CreatedAt    time.Time `json:"createdAt" db:"created_at"`
	UpdatedAt    time.Time `json:"updatedAt" db:"updated_at"`
	EquipCode    string    `json:"equipCode,omitempty" db:"-"`
	EquipName    string    `json:"equipName,omitempty" db:"-"`
	ShiftName    string    `json:"shiftName,omitempty" db:"-"`
	ShiftType    int       `json:"shiftTypeCode,omitempty" db:"-"`
}
...
type BatchMaterialLink struct {
	...
	Remark           string    `json:"remark,omitempty" db:"remark"`
	CreatedAt        time.Time `json:"createdAt" db:"created_at"`
	ProdBatchNo      string    `json:"prodBatchNo,omitempty" db:"-"`
	MaterialBatchNo  string    `json:"materialBatchNo,omitempty" db:"-"`
	MaterialName     string    `json:"materialName,omitempty" db:"-"`
	MaterialCode     string    `json:"materialCode,omitempty" db:"-"`
}
